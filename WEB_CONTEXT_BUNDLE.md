...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-5.18-kirby-problem-5.18-717ac9c8-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-5.18"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-5.18-kirby-problem-5.18-717ac9c8-v1",
      "problem_contract_sha256": "9f00d8866a51082f8aee5fcb3e4b2e84f88ca38a9902a10a376a38b9d99c80b5",
      "problem_id": "problem:um-kp-5.18-kirby-problem-5.18-717ac9c8",
      "route_id": "route:um-kp-5.18-kirby-problem-5.18-717ac9c8-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-5.18-kirby-problem-5.18-717ac9c8-source-fidelity-01",
      "graph_id": "graph:um-kp-5.18-kirby-problem-5.18-717ac9c8-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-5.18-kirby-problem-5.18-717ac9c8-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-5.18-kirby-problem-5.18-717ac9c8-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "- In higher dimensions, find the `non-analytic' cohomology module $\\HH^{*}_{?}$ analogous to the analytic lattice cohomology $\\HH^{*}_{\\mathrm{an}}$, and a natural functor $\\HH^{*}_{\\mathrm{an}}\\to \\HH^{*}_{?}$ connecting them. - Define a version $\\ECH^{*}$ of Embedded Contact Homology for isolated complex singularity links (in any dimension) associated with the canonical contact structure of the link, together with a natural graded $\\Z[U]$-module morphism $\\HH^{*}_{\\mathrm{an}}\\to \\ECH^{*}$. More precisely, - Show that this morphism is injective. - Fix the diffeomorphism type of a link, and also a contact structure on it that can be realized as the canonical contact structure associated with some singularity analytic structure. Then characterize the family $\\{\\HH^{*}_{\\mathrm{an}}\\}$, indexed by all the possible analytic germs inducing this contact link, via those graded sub-$\\Z[U]$-modules of $\\ECH^{*}$ which satisfy certain specific properties."
          },
          "statement_sha256": "112e5f6fd2a0d7900c84ee61f51d233db1b285dbe2e37fd2c3f9737f10742419"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-5.18-kirby-problem-5.18-717ac9c8-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-5.18-kirby-problem-5.18-717ac9c8-root",
      "route_id": "route:um-kp-5.18-kirby-problem-5.18-717ac9c8-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-5.18-99b79c70ad63",
        "url": "https://www.unsolvedmath.com/problems/KP-5.18"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
